...
- **Depth is a property of the interface, not the implementation.** A module can have **internal seams** (private to its implementation, used by its own tests) as well as the **external seam** at its interface.
