        ...
        <footer className="py-6 px-4 sm:px-6 text-stone-400 flex justify-between items-center">
            <div className="space-y-1 w-full">
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <Link href="https://github.com/cubingkeralaorg/cubingkerala"><p className='text-stone-600 hover:text-blue-500 hover:underline hover:underline-offset-2 cursor-pointer text-xs hidden md:block'>Github</p></Link>
                </div>
            </div>
        </footer>
    )
